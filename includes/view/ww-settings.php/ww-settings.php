...
// Weather api key 
$wather_key = get_option('ww_key');

// Wather location
$weather_location = get_option('ww_location');

// validate & save weather 
if (isset($_POST['weather_widget'])) {
	$key = sanitize_text_field($_POST['ww_key']);
	$location = sanitize_key($_POST['ww_location']);
	...
	<form action="<?php echo esc_url($_SERVER['REQUEST_URI']); ?>" method="post">
		...
		<table class="form-table">
			<tr>
				...
				<td>
					<input type="text" name="ww_key" class="regular-text" id="ww_key" value="<?php echo esc_attr($ww_key ?: ''); ?>" />
			...
			<tr>
				...
				<td>
					<input type="text" name="ww_location" class="regular-text" id="ww_location"  value="<?php echo esc_attr($ww_location ?: ''); ?>" />
